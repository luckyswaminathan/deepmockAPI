"""Standalone FastAPI application for Twilio API mock."""
...
app = FastAPI(
    title="Twilio API Mock",
    description="Generated mock API for Twilio",
    version="1.0.0",
)
        ...
        if seed_file.exists():
            ...
            for component_name, records in dataset.items():
                for record in records:
                    runtime.insert_component_record("twilio", component_name, record)
...
async def health_check():
    ...
    return {"status": "ok", "service": "twilio-api-mock"}
