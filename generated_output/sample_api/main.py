"""Standalone FastAPI application for Sample_Api API mock."""
...
app = FastAPI(
    title="Sample_Api API Mock",
    description="Generated mock API for Sample_Api",
    version="1.0.0",
)
...
async def health_check():
    ...
    return {"status": "ok", "service": "sample_api-api-mock"}
