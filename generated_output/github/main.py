"""Standalone FastAPI application for Github API mock."""
...
app = FastAPI(
    title="Github API Mock",
    description="Generated mock API for Github",
    version="1.0.0",
)
        ...
        if seed_file.exists():
            ...
            for component_name, records in dataset.items():
                for record in records:
                    runtime.insert_component_record("github", component_name, record)
...
async def health_check():
    ...
    return {"status": "ok", "service": "github-api-mock"}
